...
app.post('/api/catalogue/removeBook', CatalogueController.deleteBook);
app.post('/api/catalogue/removeMagazine', CatalogueController.deleteMagazine);
app.post('/api/catalogue/removeMovie', CatalogueController.deleteMovie);
app.post('/api/catalogue/removeMusic', CatalogueController.deleteMusic);
