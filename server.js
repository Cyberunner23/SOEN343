...
app.post('/api/catalogue/removeBook', CatalogueController.removeBook);
app.post('/api/catalogue/removeMagazine', CatalogueController.removeMagazine);
app.post('/api/catalogue/removeMovie', CatalogueController.removeMovie);
app.post('/api/catalogue/removeMusic', CatalogueController.removeMusic);
